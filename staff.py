...
class Veterinarian(Staff):
    ...
    def __str__(self):
        return_string = Fore.YELLOW + f"{self.name} is a veterinarian employed on {self.date_employed}.\n"
        return_string += Style.RESET_ALL  + f"Their responsibilities include : {self.responsibilities}\n"
        return_string += f"They can treat : {self.animals_can_treat}\n"
...
class Zookeeper(Staff):
    ...
    def __str__(self):
        return_string = Fore.YELLOW + f"{self.name} is a zookeeper employed on {self.date_employed}.\n"
        return_string += Style.RESET_ALL  + f"Their responsibilities include : {self.responsibilities}\n"
...
class Operations(Staff):
    ...
    def __str__(self):
        return_string = Fore.YELLOW + f"{self.name} is a operations person employed on {self.date_employed}.\n"
        return_string += Style.RESET_ALL  + f"Their responsibilities include : {self.responsibilities}\n"
